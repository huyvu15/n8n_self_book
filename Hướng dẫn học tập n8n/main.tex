...
urlcolor=blue,
citecolor=cyan,
linktoc=all,        % Cả tiêu đề và số trang có thể nhấn được
% linktocpage=true,   % Nhấn được cả số trang
...
% Sections
\input{sections/chap1}
\clearpage
\input{sections/chap2}
\clearpage
\input{sections/chap3}
\clearpage
\input{sections/chap4}
\clearpage
\input{sections/chap5}
\clearpage
\input{sections/chap7}
\clearpage
\input{sections/chap8}
\clearpage
\input{sections/chap9}
\clearpage
\input{sections/chap10}
\clearpage
\input{sections/chap12}
\clearpage
\input{sections/ref}
